...
from trainer import SelfSupervisedTrainer, SupervisedTrainer

MODELS = {
    "ResNetSimCLR": ResNetSimCLR,
    "ResNet": ResNet,
}
...
parser.add_argument(
    "--out_dim", default=100, type=int, help="feature dimension (default: 100)"
)
parser.add_argument(
...
def main():
    ...
    model = MODELS[args.arch](out_dim=args.out_dim)
